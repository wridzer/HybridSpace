...
public class HelmetPos : MonoBehaviourPun
{
    ...
    void Update()
    {
        ...
        Vector3 puntD = new Vector3(leftHand.transform.position.x + (difference.x * 0.5f), transform.position.y + cameraInstance.transform.forward.y + offsetRot, leftHand.transform.position.z + (difference.z * 0.5f));
